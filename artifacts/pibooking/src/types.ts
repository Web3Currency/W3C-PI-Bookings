...
export type BookingStatus = 'Pending' | 'Confirmed' | 'In Progress' | 'Completed' | 'Cancelled' | 'Disputed' | 'Refunded';
...
export interface Booking { id: string; serviceId: string; serviceName: string; durationMinutes: number; basePrice: number; currency: string; priceNGN: number; pricePi: number; date?: string; timeSlot?: string; clientName: string; clientPiUsername: string; clientPiUid?: string; clientPhone: string; clientEmail?: string; notes?: string; attachments?: BookingAttachment[]; status: BookingStatus; paymentStatus: PaymentStatus; escrow_status?: EscrowStatus | string; paid_at?: string; confirmed_at?: string; accepted_at?: string; project_started_at?: string; project_deadline?: string; released_at?: string; refunded_at?: string; cancelled_at?: string; acceptance_deadline?: string; platform_fee_pi?: number; provider_payout_pi?: number; rejection_reason?: string; providerId?: string; providerName?: string; providerPiUsername?: string; providerPhotoUrl?: string; providerWalletAddress?: string; payoutTxHash?: string; createdAt: string; updatedAt?: string; piTxHash?: string; piPaymentId?: string; qrCodeUrl?: string; rating?: number; reviewComment?: string; reviewDate?: string; }
