...
import { ArrowLeft, Camera, Loader2, UserRound } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto pb-24 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center justify-between mb-6">
        <button type="button" onClick={onBack} className="px-4 py-2 rounded-full bg-zinc-100 text-zinc-800 text-xs font-bold hover:bg-zinc-200 transition cursor-pointer flex items-center gap-2">
