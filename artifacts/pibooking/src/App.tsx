...
export default function App() {
  ...
  const [clientDetails, setClientDetails] = useState<ClientDetails>({clientName:'',clientPiUsername:'',clientPhone:'',clientEmail:'',notes:'',attachments:[]});
  ...
  const handleConfirmDetails=(details:ClientDetails)=>{setActiveTab('browse');setClientDetails(details);setCurrentFlow('select_schedule');};
